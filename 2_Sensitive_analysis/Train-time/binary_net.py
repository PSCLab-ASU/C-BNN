...
def train(train_fn,val_fn,
    ...
    # Save training loss, valid loss, valid error, testing loss, testing error
    train_loss_mat = np.zeros((num_epochs))
    val_err_mat = np.zeros((num_epochs))
    val_loss_mat = np.zeros((num_epochs))
    test_err_mat = np.zeros((num_epochs))
    test_loss_mat = np.zeros((num_epochs))
    ...
    for epoch in range(num_epochs):
        ...
        train_loss_mat[epoch] = str(train_loss)
        val_err_mat[epoch] = str(val_err)
        val_loss_mat[epoch] = str(val_loss)
        test_err_mat[epoch] = str(test_err)
        test_loss_mat[epoch] = str(test_loss)
        ...
        # export training loss, valid loss, valid error, testing loss, testing error
        if epoch%50 == 49:
            np.savetxt('train_loss_mat.txt',train_loss_mat,delimiter=' ')
            np.savetxt('val_err_mat.txt',val_err_mat,delimiter=' ')
            np.savetxt('val_loss_mat.txt',val_loss_mat,delimiter=' ')
            np.savetxt('test_err_mat.txt',test_err_mat,delimiter=' ')
            np.savetxt('test_loss_mat.txt',test_loss_mat,delimiter=' ')
